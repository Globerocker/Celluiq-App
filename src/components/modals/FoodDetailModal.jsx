      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          {food.primary_benefits && (
            <div className="bg-[#0A0A0A] rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-white font-semibold">Gesundheitsvorteile</h3>
              </div>
          ...
          {food.influenced_markers && (
            <div className="bg-[#3B7C9E10] border border-[#3B7C9E30] rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-white font-semibold">Beeinflusste Biomarker</h3>
              </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#0A0A0A] rounded-xl p-4">
              <p className="text-[#666666] text-xs mb-1">Tägliche Menge</p>
              <p className="text-white font-semibold">{food.daily_dosage || '-'}</p>
            </div>
            <div className="bg-[#0A0A0A] rounded-xl p-4">
              <p className="text-[#666666] text-xs mb-1">Wöchentliche Menge</p>
          ...
          {food.best_time && (
            <div className="bg-[#0A0A0A] rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-white font-semibold">Beste Einnahmezeit</h3>
              </div>
              <p className="text-[#808080]">{bestTimeLabels[food.best_time] || food.best_time}</p>
            </div>
          )}
          ...
          {food.combinations && (
            <div className="bg-[#0A0A0A] rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-white font-semibold">Optimale Kombinationen</h3>
              </div>
