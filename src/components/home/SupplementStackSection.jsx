    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <h2 className="text-xl font-bold text-white mb-3">{t('noRecommendationsYet')}</h2>
          <p className="text-[#808080] max-w-sm mx-auto">
            {t('uploadForSupplements')}
          </p>
        </div>
      </div>
    );
      ...
      {isPro ? (
        <div className="bg-[#111111] rounded-2xl p-5 border border-[#1A1A1A]">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-white font-semibold">{t('eveningStack')}</h3>
              <p className="text-[#666666] text-xs">{t('takeBeforeBed')}</p>
            </div>
          </div>
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
            ...
            <p className="text-white font-semibold text-sm">{t('eveningStack')}</p>
            <p className="text-[#B7323F] text-xs font-medium mt-1">PRO • €9</p>
          </div>
        </div>
      )}
    </div>
